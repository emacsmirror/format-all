...
* **CSS/Less/SCSS** ([*prettier*](https://prettier.io/), [*prettierd*](https://github.com/fsouza/prettierd), [*deno*](https://deno.land/manual/tools/formatter), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
...
* **GraphQL** ([*prettier*](https://prettier.io/), [*prettierd*](https://github.com/fsouza/prettierd), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
...
* **HTML** ([*tidy*](http://www.html-tidy.org/), [*deno*](https://deno.land/manual/tools/formatter), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
...
* **JavaScript/JSON/JSX** ([*prettier*](https://prettier.io/), [*standard*](https://standardjs.com/), [*prettierd*](https://github.com/fsouza/prettierd), [*deno*](https://deno.land/manual/tools/formatter), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
* **JSON5** ([*prettier*](https://prettier.io/), [*deno*](https://deno.land/manual/tools/formatter), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
...
* **Markdown** ([*prettier*](https://prettier.io/), [*prettierd*](https://github.com/fsouza/prettierd), [*deno*](https://deno.land/manual/tools/formatter), [*markdownfmt*](https://github.com/shurcooL/markdownfmt), [*mdformat*](https://github.com/hukkin/mdformat), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
...
* **TOML** ([*prettier plugin*](https://github.com/bd82/toml-tools/tree/master/packages/prettier-plugin-toml), [*taplo fmt*](https://taplo.tamasfe.dev/cli/usage/formatting.html), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
* **TypeScript/TSX** ([*prettier*](https://prettier.io/), [*ts-standard*](https://standardjs.com/), [*prettierd*](https://github.com/fsouza/prettierd), [*deno*](https://deno.land/manual/tools/formatter), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
* **V** ([*v fmt*](https://github.com/vlang/v))
* **Vue** ([*prettier*](https://prettier.io/), [*prettierd*](https://github.com/fsouza/prettierd), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
...
* **YAML** ([*prettier*](https://prettier.io/), [*prettierd*](https://github.com/fsouza/prettierd), [*deno*](https://deno.land/manual/tools/formatter), [*oxfmt*](https://oxc.rs/docs/guide/usage/formatter))
